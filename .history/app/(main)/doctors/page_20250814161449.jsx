...
/*************  ✨ Windsurf Command ⭐  *************/
/**
 * Page displaying a list of all available doctor specialties. Each specialty
 * links to a page displaying all doctors with that specialty.
 *
 * @returns {JSX.Element} The doctor page component.
 * @example
 * <DoctorPage />
 */
/*******  a25dde62-0bca-4d74-bdd3-d3eb6ab9a404  *******/
