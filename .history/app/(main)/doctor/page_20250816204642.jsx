...
// import DoctorEarnings from "./_components/doctor-earnings";
    ...
    return (
        ...
        >
        <TabsList className="md:col-span-1 bg-muted/30 border h-14 md:h-40 flex sm:flex-row md:flex-col w-full cursor-pointer p-2 md:p-1 rounded-md md:space-y-2 sm:space-x-2 md:space-x-0">
            <TabsTrigger
            value="earnings"
