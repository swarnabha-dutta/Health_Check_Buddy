...
export async function verifyAdmin() {
    ...
    try {
        ...
        D("Failed to verify admin:", error);
        return false;
    }
}
...
export async function getVerifiedDoctors() {
    ...
    try {
        ...
        D("Failed to get verified doctors:", error);
...
export async function updateDoctorStatus(formData) {
    ...
    try {
        ...
        D("Failed to update doctor status:", error);
...
export async function updateDoctorActiveStatus(formData) {
    ...
    try {
        ...
        D("Failed to update doctor active status:", error);
        throw new Error(`Failed to update doctor status: ${error.message}`);
    }
}
...
export async function getPendingPayouts() {
    ...
    try {
        ...
        D("Failed to fetch pending payouts:", error);
...
export async function approvePayout(formData) {
    ...
    try {
        ...
        D("Failed to approve payout:", error);
